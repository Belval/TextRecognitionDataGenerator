...
class GeneratorFromWikipedia:
    def __init__(
        ...
        """Generator that uses words taken from random Wikipedia articles

        :param count: Number of samples to pre-generate, defaults to -1
        :type count: int, optional
        :param minimum_length: Minimum number of words in the crop, defaults to 1
        :type minimum_length: int, optional
